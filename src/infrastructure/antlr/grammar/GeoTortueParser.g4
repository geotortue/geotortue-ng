// GTNToken.ts (src/domain/types/) is automatically generated by script scripts/generate-antlr-token-enum.ts after each ANTRL4 run.

// GTNSyntaxService.getTokenStyleMap (src/domain/services/) must be manually updated after any addition or suppression of **rules**, i.e.:
...
// - scripts/generate-antlr-token-enum.ts
// - scripts/generate-command-arities.ts
